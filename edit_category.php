...
$edit = mysqli_fetch_array(mysqli_query($conn, "select * from `category` where id='" . $_GET['edit'] . "'"));
?>
               ...
               <h4 class="mt-0 header-title">Edit Category</h4>
                    ...
                    <input type="hidden" name="ids" value="<?php echo $_GET['edit']; ?>">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="category_name" value="<?php echo $edit['category_name']; ?>" required placeholder="Category Name"/>
                        </div>
                        <div class="form-group">
