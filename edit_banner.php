...
$edit = mysqli_fetch_array(mysqli_query($conn, "select * from `banner` where id='" . $_GET['edit'] . "'"));
?>
               ...
               <h4 class="mt-0 header-title">Edit Banner</h4>
                    ...
                    <input type="hidden" name="ids" value="<?php echo $_GET['edit']; ?>">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="heading" value="<?php echo $edit['heading']; ?>" required placeholder="Banner Name"/>
                        </div>
                        <div class="form-group">
