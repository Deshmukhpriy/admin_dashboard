...
if (isset($_GET['delete'])) {
	...
	echo "<script>alert('deleted successfully');window.location='show_category.php';</script>";
}
?>
<!-- DataTables -->
        ...
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body">
                 ...
                 <p style="float:right;margin-top:-30px;"><a class="btn btn-warning" href="add_category.php">Add Category</a></p>
                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;margin-top:20px;">
                        ...
                        <?php
						$n = '1';
						$sqlii = mysqli_query($conn, "SELECT * FROM `category`  ORDER BY  id  ASC");
						...
						<a href="edit_category.php?edit=<?php echo $rows['id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true" style="color:blue;font-size:18px"></i>
						</a>
						</td>
						</tr>
                        <?php } ?>
