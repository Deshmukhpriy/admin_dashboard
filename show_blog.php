...
if (isset($_GET['delete'])) {
	mysqli_query($conn, "delete from blog where id='" . $_GET['delete'] . "'");
	echo "<script>alert('deleted successfully');window.location='show_blog.php';</script>";
}
?>
<!-- DataTables -->
        ...
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body">
                 ...
                 <p style="float:right;margin-top:-30px;"><a class="btn btn-warning" href="add_blog.php">Add Blog</a></p>
                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;margin-top:20px;">
                        ...
                        <?php
						$n = '1';
						$sqlii = mysqli_query($conn, "SELECT * FROM `blog`  ORDER BY  id  ASC");
						...
						<a href="edit_blog.php?edit=<?php echo $rows['id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true" style="color:blue;font-size:18px"></i>
						</a>
						</td>
						</tr>
                        <?php } ?>
